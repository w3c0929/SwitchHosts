...
export default {
  ...
  notify: 'Notification',
  notify_desc: 'Send a push notification when a download succeeds or fails.',
  notify_dingtalk: 'DingTalk',
  notify_dingtalk_secret: 'Sign secret (optional)',
  notify_format: 'Content Format',
  notify_format_markdown: 'Markdown',
  notify_format_text: 'Text',
  notify_message: 'Notification Content',
  notify_message_placeholder:
    'Leave empty for the default message. Placeholders: {title} {result} {message}',
  notify_other: 'Other',
  notify_wecom: 'WeCom',
  overwrite: 'Overwrite',
  password: 'Password',
  ...
  save_path_desc:
    'After each refresh, a copy of the downloaded content is also saved to this file path. Leave empty to disable.',
  search: 'Search',
  ...
  system_hosts_history_clear_confirm:
    'Are you sure you want to clear all system hosts history records?',
