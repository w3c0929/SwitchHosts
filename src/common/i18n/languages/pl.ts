...
export default {
  ...
  notify_desc: 'Wysyła powiadomienie po pomyślnym lub nieudanym pobraniu.',
  notify_dingtalk: 'DingTalk',
  notify_dingtalk_secret: 'Klucz podpisu (opcjonalny)',
  notify_format: 'Format treści',
  notify_format_markdown: 'Markdown',
  notify_format_text: 'Tekst',
  notify_message: 'Treść powiadomienia',
  notify_message_placeholder:
    'Pozostaw puste, aby użyć domyślnej wiadomości. Symbole: {title} {result} {message}',
  notify_other: 'Inne',
  notify_wecom: 'WeCom',
  overwrite: 'Nadpisz',
  password: 'Hasło',
  ...
  save_path: 'Lokalna ścieżka zapisu',
  save_path_desc:
    'Po każdym odświeżeniu kopia pobranej treści zostanie również zapisana w tym pliku. Pozostaw puste, aby wyłączyć.',
  search: 'Szukaj',
  ...
  system_hosts_history_clear_confirm:
    'Czy na pewno chcesz wyczyścić wszystkie rekordy historii hosts systemowych?',
