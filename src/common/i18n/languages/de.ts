...
const lang: LanguageDict = {
  ...
  notify_desc: 'Benachrichtigen, wenn ein Download abgeschlossen oder fehlgeschlagen ist.',
  notify_dingtalk: 'DingTalk',
  notify_dingtalk_secret: 'Signaturschlüssel (optional)',
  notify_format: 'Inhaltsformat',
  notify_format_markdown: 'Markdown',
  notify_format_text: 'Text',
  notify_message: 'Benachrichtigungsinhalt',
  notify_message_placeholder:
    'Leer lassen für die Standardmeldung. Platzhalter: {title} {result} {message}',
  notify_other: 'Andere',
  notify_wecom: 'WeCom',
  ...
  save_path: 'Lokaler Speicherpfad',
  save_path_desc:
    'Nach jeder Aktualisierung wird eine Kopie der heruntergeladenen Inhalte auch in diesem Dateipfad gespeichert. Leer lassen, um zu deaktivieren.',
  search: 'Suchen',
  ...
  system_hosts_history_clear_confirm:
    'Möchten Sie wirklich alle Verlaufsdatensätze der System-Hosts löschen?',
