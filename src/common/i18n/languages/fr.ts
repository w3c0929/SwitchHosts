...
const lang: LanguageDict = {
  ...
  notify: 'Notification',
  notify_desc: 'Envoie une notification lorsqu\'un téléchargement réussit ou échoue.',
  notify_dingtalk: 'DingTalk',
  notify_dingtalk_secret: 'Secret de signature (optionnel)',
  notify_format: 'Format du contenu',
  notify_format_markdown: 'Markdown',
  notify_format_text: 'Texte',
  notify_message: 'Contenu de la notification',
  notify_message_placeholder:
    'Laissez vide pour le message par défaut. Variables : {title} {result} {message}',
  notify_other: 'Autre',
  notify_wecom: 'WeCom',
  overwrite: 'Écraser',
  ...
  save_path: 'Chemin de sauvegarde local',
  save_path_desc:
    'Après chaque actualisation, une copie du contenu téléchargé est également enregistrée dans ce chemin de fichier. Laissez vide pour désactiver.',
  search: 'Rechercher',
  ...
  system_hosts_history_clear_confirm:
    'Voulez-vous vraiment effacer tous les enregistrements de l\'historique des hosts système ?',
