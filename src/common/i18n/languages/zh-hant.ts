...
const lang: LanguageDict = {
  ...
  all: '全部',
  append: '附加',
  as_hosts: '作為 Hosts 內容應用',
  as_hosts_desc:
    '開啟時，抓取到的內容作為 hosts 使用（可寫入系統 hosts）；關閉時僅用於定時抓取/觸發，內容不會進入 hosts，可搭配「本機儲存路徑」儲存檔案。',
  show_content: '顯示右側內容',
  show_content_desc:
    '開啟時，選中該方案後右側主編輯器區域顯示其內容；關閉時右側編輯器不顯示內容，僅作為列表中的一個條目存在。預設開啟。',
  ...
  no_record: '沒有紀錄',
  notify: '通知',
  notify_desc: '下載完成或失敗時，推播通知到以下管道。',
  notify_dingtalk: '釘釘',
  notify_dingtalk_secret: '加簽密鑰（可選）',
  notify_format: '內容格式',
  notify_format_markdown: 'Markdown',
  notify_format_text: '文本',
  notify_message: '通知內容',
  notify_message_placeholder: '留空使用預設提示；支援佔位符 {title} {result} {message}',
  notify_other: '其他',
  notify_wecom: '企業微信',
  overwrite: '覆寫',
  password: '密碼',
  ...
  save_success: '儲存成功',
  save_path: '本機儲存路徑',
  save_path_desc: '每次重新整理遠端內容後，會將下載的內容另存到該檔案路徑；留空則不儲存。',
  search: '搜尋',
  select_all: '全選',
  selected: '已選',
  settings: '設定',
  ...
  system_hosts_history_clear_confirm: '確定要清空所有系統 Hosts 歷史版本記錄嗎？',
  ...
  url_script_desc:
    '該 URL 指向本機 PowerShell 腳本（.ps1），將以觸發型方案執行：重新整理時自動執行該指令碼，執行結果在右側編輯器顯示，內容不會進入系統 hosts。',
