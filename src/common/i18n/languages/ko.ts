...
export default {
  ...
  url_script_desc:
    '이 URL은 로컬 스크립트(.ps1 / .bat / .cmd)를 가리킵니다. 트리거형 스킴으로 동작하여 새로고침 시 스크립트가 자동 실행되고 결과가 오른쪽 편집기에 표시됩니다. 내용이 시스템 hosts에 들어가지 않습니다. 스크립트가 생성한 파일은 기본적으로 스크립트와 같은 폴더에 저장되며, 아래의 "로컬 저장 경로"에서 출력 폴더를 지정할 수 있습니다.',
