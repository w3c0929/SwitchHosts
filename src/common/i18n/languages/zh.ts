...
const lang: LanguageDict = {
  ...
  no_record: '没有记录',
  notify: '通知',
  notify_desc: '下载完成或失败时，推送通知到以下渠道。',
  notify_dingtalk: '钉钉',
  notify_dingtalk_secret: '加签密钥（可选）',
  notify_format: '内容格式',
  notify_format_markdown: 'Markdown',
  notify_format_text: '文本',
  notify_message: '通知内容',
  notify_message_placeholder: '留空使用默认提示；支持占位符 {title} {result} {message}',
  notify_other: '其他',
  notify_wecom: '企业微信',
  overwrite: '覆盖',
  password: '密码',
  ...
  save_success: '保存成功',
  save_path: '本地保存路径',
  save_path_desc: '每次刷新远程内容后，将下载的内容另存到该文件路径；留空则不保存。',
  search: '搜索',
  select_all: '全选',
  selected: '已选',
  settings: '设置',
  ...
  system_hosts_history_clear_confirm: '确实要清空所有系统 Hosts 历史版本记录吗？',
