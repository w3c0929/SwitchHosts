...
export default {
  ...
  no_record: 'Kayıt yok',
  notify: 'Bildirim',
  notify_desc: 'İndirme başarılı veya başarısız olduğunda bildirim gönderir.',
  notify_dingtalk: 'DingTalk',
  notify_dingtalk_secret: 'İmza anahtarı (isteğe bağlı)',
  notify_format: 'İçerik biçimi',
  notify_format_markdown: 'Markdown',
  notify_format_text: 'Metin',
  notify_message: 'Bildirim içeriği',
  notify_message_placeholder:
    'Varsayılan mesaj için boş bırakın. Değişkenler: {title} {result} {message}',
  notify_other: 'Diğer',
  notify_wecom: 'WeCom',
  ...
  save_path: 'Yerel Kayıt Konumu',
  save_path_desc:
    'Her yenilemede indirilen içeriğin bir kopyası da bu dosya yoluna kaydedilir. Boş bırakılırsa kaydedilmez.',
  search: 'Ara',
  ...
  system_hosts_history_clear_confirm:
    'Tüm sistem hosts geçmişi kayıtlarını temizlemek istediğinize emin misiniz?',
  ...
  url_script_desc:
    'Bu URL yerel bir betiğe (.ps1 / .bat / .cmd) işaret eder: tetikleyici türünde çalışır — yenileme betiği otomatik olarak çalıştırır ve sonuç sağdaki düzenleyicide gösterilir. İçerik sistem hosts dosyasına asla girmez. Betiğin ürettiği dosyalar varsayılan olarak betiğin yanına yazılır; aşağıdaki "Yerel Kayıt Yolu" ile farklı bir çıktı klasörü seçebilirsiniz.',
